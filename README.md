...
**Status:** ✅ Sprint 0 DONE — Deploy live, auth funcional, CRUD users operacional, RLS corrigido, **mobile-first UI** (sidebar responsivo, cards ao invés de tabelas). **UX components criados** (Button, Card, Badge, Alert, Input, Select, Textarea, Modal, Toast, Loading, EmptyState, KPICard). Pronto para Sprint 1 (NC Core).
